 ...
 * @dev Usage: forge script scripts/merkleDistributor/GenerateProof.s.sol --sig "generateProof(string,address)" "merkle-tree.json" "0x123..."
 */
contract GenerateProof is Script {
     ...
     */
    function findRecipientIndex(Recipient[] memory recipients, address targetAddress) 
        internal 
        pure 
        returns (uint256) 
    {
     ...
     */
    function generateMerkleProof(Recipient[] memory recipients, uint256 targetIndex) 
        internal 
        pure 
     ...
     * @return proof Merkle proof array
     */
    function buildProof(bytes32[] memory leaves, uint256 targetIndex) 
        internal 
        pure 
        returns (bytes32[] memory) 
    {
     ...
     */
    function buildNextLevelForProof(bytes32[] memory currentLevel) 
        internal 
        pure 
        returns (bytes32[] memory) 
    {
     ...
     */
    function verifyProof(bytes32[] memory proof, bytes32 leaf, bytes32 root) 
        internal 
        pure 
        returns (bool) 
    {
