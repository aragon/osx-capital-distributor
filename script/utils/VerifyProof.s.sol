 ...
 * @dev Usage: forge script scripts/merkleDistributor/VerifyProof.s.sol --sig
 * "verifyProof(bytes32,address,uint256,bytes32[])" "0xroot..." "0xrecipient..." "1000000000000000000"
 * "[0xproof1,0xproof2]"
 */
contract VerifyProof is Script {
     ...
     */
    function verifyProof(bytes32 merkleRoot, address recipient, uint256 amount, bytes32[] memory proof) external view {
