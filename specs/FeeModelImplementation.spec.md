...
## Overview
This document specifies the implementation of a fee model for allocator strategies in the OSX Capital Distributor system. The fee model allows strategy developers to charge a small fee when users claim their allocations, with fees being strategy-specific and immutable once set.
