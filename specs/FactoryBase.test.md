...
## 🧠 Function Overview
I want you to write an in-depth test suite for the factory base contract.
It's used by two other contracts as the shared based:
- AllocatorStrategyFactory.sol
- ActionEncoderFactory.sol

These contracts serve as registry and factories for other contracts. These contracts can be of two types: ActionEncoders and AllocatorStrategies. But for the FactoryBase, that's not of importance.
