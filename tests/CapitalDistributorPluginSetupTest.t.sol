...
contract CapitalDistributorPluginSetupTest is Test {
    ...
    bytes32 internal constant UPGRADE_PLUGIN_PERMISSION_ID = keccak256("UPGRADE_PLUGIN_PERMISSION_ID");
    ...
    function setUp() public {
        ...
        dao = DAO(
            payable(createProxyAndCall(DAO_BASE, abi.encodeCall(DAO.initialize, ("Test DAO", address(this), address(0x0), ""))))
        );
    ...
    function test_WhenPreparingAnInstallation() external whenPreparingAnInstallation {
        ...
        assertEq(preparedSetupData.permissions.length, 3, "permissions length mismatch");
    ...
    function test_WhenPreparingAnUninstallation() external whenPreparingAnUninstallation {
        ...
        assertEq(revokePermissions.length, 3, "uninstallation permissions length mismatch");
